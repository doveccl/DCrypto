/**
  *This code is an encryption head file created by Doveccl.
  *You have free access to use this code.
  *This file has no copyright assigned.
  */

#ifndef __Doveccl_Encryption_H__
#define __Doveccl_Encryption_H__
...
private:
	...
	*/
	...
	int enc_init_map(UINT8 seed)
	{
		...
		std::random_shuffle(enc_map, enc_map + len);
